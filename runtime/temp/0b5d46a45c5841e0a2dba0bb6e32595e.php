<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:75:"/data/home/bxu2713310775/htdocs/application/admin/view/index/up_notice.html";i:1501653317;}*/ ?>
    ...
    <div class="tpl-block ">
        ...
        <div class="am-g tpl-amazeui-form">
            ...
            <div class="am-u-sm-12 am-u-md-9">
                <form action="<?php echo url('Index/do_up_notice'); ?>" method="post"  class="am-form am-form-horizontal">
                    <div class="am-form-group">
                        <label for="rule_zh_name" class="am-u-sm-3 am-form-label">新闻标题 / Title</label>
                        <div class="am-u-sm-9">
                            <input type="hidden" name="id" value="<?php echo $userinfo['id']; ?>"/>
                            <input type="text" name="title" value="<?php echo $userinfo['title']; ?>" id="rule_zh_name" placeholder="新闻标题 / Title">
                     ...
                     <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                            <input type="hidden" name="id" value="<?php echo $userinfo['id']; ?>"/>
                            <input type="text" name="futitle" value="<?php echo $userinfo['futitle']; ?>" id="rule_zh_name" placeholder="新闻副标题 / Title">
                            <small id="showzhmsg"></small>
                        </div>
                    </div>
                    ...
                    <!-- <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                            <select name="cid">
                                ...
                                <option value="<?php echo $vo['id']; ?>" <?php if($userinfo['cid'] == $vo['id']): ?> selected="selected"<?php endif; ?>><?php echo $vo['id']; ?></option>
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                            <select name="tid">
                                ...
                                <option value="<?php echo $vo['id']; ?>" <?php if($userinfo['cid'] == $vo['id']): ?> selected="selected"<?php endif; ?>><?php echo $vo['truename']; ?></option>
                                <?php endforeach; endif; else: echo "" ;endif; ?>
                            </select>
                        </div>
                    </div>
