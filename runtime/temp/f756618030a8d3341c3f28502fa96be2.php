            ...
            <div class="am-u-sm-12 am-u-md-9">
                <form action="<?php echo url('Index/telephone'); ?>" method="post"  class="am-form am-form-horizontal">
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                            <input type="text" name="child" value="<?php echo $info['child']; ?>"  placeholder="输入姓名 / name"><small></small>
                        </div>
                    </div>
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                            <input type="text" name="telephone"  value="<?php echo $info['telephone']; ?>"  placeholder="输入号码 / Telephone">
                        </div>
                    </div>
