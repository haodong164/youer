<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:80:"/data/home/bxu2713310775/htdocs/application/admin/view/index/addtheme_reply.html";i:1499931754;}*/ ?>
<!doctype html>
<html>
    ...
    <div class="tpl-block ">
        ...
        <div class="am-g tpl-amazeui-form">
            ...
            <div class="am-u-sm-12 am-u-md-9">
                <form class="am-form am-form-horizontal" action="<?php echo url('Index/do_addtheme_reply'); ?>" method="post">
                    <input type="hidden" name="id" value="<?php echo $id; ?>">

                    <div class="am-form-group">
                        <label for="user-intro" class="am-u-sm-3 am-form-label">话题标题 /Title</label>
                        <div class="am-u-sm-9">
                            <select name="eid">
                                <option>请选择</option>
                                ...
                                <option value="<?php echo $val['id']; ?>" <?php if($id == $val['id']): ?> selected="selected" <?php endif; ?>><?php echo $val['title']; ?></option>
                    ...
                    <div class="am-form-group">
                        <label for="user-intro" class="am-u-sm-3 am-form-label">身份 /Inden</label>
                        <div class="am-u-sm-9">
                            <input name="inden" type="radio" value="0" checked="checked">教师
                            <input name="inden" type="radio" value="1">家长
                        </div>
                    </div>
                    <div class="am-form-group">
