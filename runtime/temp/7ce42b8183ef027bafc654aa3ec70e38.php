                    ...
                    <div class="am-u-sm-12 am-u-md-6">
                        <div class="am-btn-toolbar">
                            <div class="am-btn-group am-btn-group-xs">
                                <a href="<?php echo url('Index/comment'); ?>" type="button" class="am-btn am-btn-default am-btn-success"><span class="am-icon-plus"></span> 新增</a>
                        ...
                        <form class="am-form">
                            <table class="am-table am-table-striped am-table-hover table-main">
                                ...
                                <tr>
                                    ...
                                    <th class="table-type">评价教师</th>
                                    <th class="table-author am-hide-sm-only">评价内容</th>
                                    <th class="table-date am-hide-sm-only">评价日期</th>
                                ...
                                <tr>
                                    ...
                                    <td class="am-hide-sm-only"><?php echo $list['content']; ?></td>
                                    <td class="am-hide-sm-only"><?php echo $list['pubdate']; ?></td>
                                    <td>
                                        <div class="am-btn-toolbar">
                                            <div class="am-btn-group am-btn-group-xs">

                                                <a href="<?php echo url('Index/upbianji',['id'=>$list['id']]); ?>" class="am-btn am-btn-default am-btn-xs am-text-secondary"><span class="am-icon-pencil-square-o"></span> 编辑</a>
                                                <a href="<?php echo url('Index/deshanchu',['id'=>$list['id']]); ?>" class="am-btn am-btn-default am-btn-xs am-text-secondary"><span class="am-icon-pencil-square-o"></span> 删除</a>
