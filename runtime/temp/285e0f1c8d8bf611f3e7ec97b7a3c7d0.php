    ...
    <div class="tpl-block ">
        ...
        <div class="am-g tpl-amazeui-form">
            ...
            <div class="am-u-sm-12 am-u-md-9">
                <form class="am-form am-form-horizontal" method="post" action="<?php echo url('Index/do_leyuan'); ?>" enctype="multipart/form-data">
                    <div class="am-form-group">
                        <label for="user-name" class="am-u-sm-3 am-form-label">标题 / title</label>
                        <div class="am-u-sm-9">
                            <input type="hidden" name="id" value="<?php echo $info['id']; ?>" >
                            <input type="text" name="title" value="<?php echo $info['title']; ?>" id="user-name" placeholder="标题 / Title">
                            <small>请输入标题</small>
                        </div>
                    </div>
                    <div class="am-form-group">
                        <label for="user-name" name="phone" class="am-u-sm-3 am-form-label">封面 / Photo</label>
                        <div class="am-u-sm-9">
                    ...
                    <div class="am-form-group">
                        <label for="user-intro" class="am-u-sm-3 am-form-label">简介 / Content</label>
                        <div class="am-u-sm-9">
                            <textarea class="" rows="5" name="content" id="user-intro" placeholder="精彩活动简介"><?php echo $info['content']; ?></textarea>
                            <small>250字以内写出你的不同</small>
                        </div>
                    </div>
