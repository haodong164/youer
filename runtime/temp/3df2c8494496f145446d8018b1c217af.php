            ...
            <div class="am-u-sm-12 am-u-md-6">
                <div class="am-btn-toolbar">
                    <div class="am-btn-group am-btn-group-xs">
                        <a href="<?php echo url('Index/add_rules'); ?>" class="am-btn am-btn-default am-btn-success"><span class="am-icon-plus"></span> 新增</a>
                ...
                <form class="am-form">
                    <table class="am-table am-table-striped am-table-hover table-main">
                        ...
                        <tr>
                            ...
                            <th class="table-title">权限英文</th>
                            <th class="table-type">权限中文</th>
                            <th class="table-type">状态</th>
                            <th class="table-set">操作</th>
                        </tr>
                        </thead>
                        <tbody>
                        <?php if(is_array($val) || $val instanceof \think\Collection || $val instanceof \think\Paginator): if( count($val)==0 ) : echo "" ;else: foreach($val as $key=>$vo): ?>
                        <tr>
                            ...
                            <td>
                                <div class="am-btn-toolbar">
                                    <div class="am-btn-group am-btn-group-xs">
                                        ...
                                        <a  href="<?php echo url('Index/del_groupinfo',['id'=>$vo['id']]); ?>"class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only"><span class="am-icon-trash-o"></span> 删除</a>
                                    </div>
                                </div>
                            </td>
                        </tr>
