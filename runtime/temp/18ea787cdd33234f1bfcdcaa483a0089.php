    ...
    <div class="tpl-block ">
        ...
        <div class="am-g tpl-amazeui-form">
            ...
            <div class="am-u-sm-12 am-u-md-9">
                <form action="<?php echo url('Index/do_addstudent'); ?>" method="post" enctype="multipart/form-data" class="am-form am-form-horizontal">
                        ...
                        <div class="am-u-sm-9">
                            <!-- <input type="text" name="fid"><small>输入这孩子家长的ID</small> -->
                             ...
                             <option>请选择家长姓名</option>
                                           ...
                                           <option value=<?php echo $fname['id']; ?> ><?php echo $fname['truename']; ?></option>
                                           <?php endforeach; endif; else: echo "" ;endif; ?>
                             </select>
