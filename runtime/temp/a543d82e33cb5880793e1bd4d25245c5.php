    ...
    <div class="tpl-block ">
        ...
        <div class="am-g tpl-amazeui-form">
            ...
            <div class="am-u-sm-12 am-u-md-9">
                <form action="<?php echo url('Index/do_up_photo_group'); ?>" method="post" class="am-form am-form-horizontal">
                    <div class="am-form-group">
                        <label for="rule_en_name" class="am-u-sm-3 am-form-label">相册名字/ Name</label>
                        <div class="am-u-sm-9">
                            <input type="hidden" name="id" value="<?php echo $info['id']; ?>">
                            <input type="text" name="title" id="rule_en_name" value="<?php echo $info['title']; ?>" placeholder="相册名字 / Name">
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                            <select name="tid">
                                ...
                                <option <?php if($info['tid'] == $vo['id']): ?> selected="selected"<?php endif; ?> value="<?php echo $vo['id']; ?>"><?php echo $vo['truename']; ?></option>
