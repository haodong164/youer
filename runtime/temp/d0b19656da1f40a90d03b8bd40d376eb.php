<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:76:"/data/home/bxu2713310775/htdocs/application/admin/view/index/noticelist.html";i:1501414055;}*/ ?>
<!doctype html>
<html>
                    ...
                    <div class="am-u-sm-12 am-u-md-6">
                        <div class="am-btn-toolbar">
                            <div class="am-btn-group am-btn-group-xs">
                                <a href="<?php echo url('Index/add_notice'); ?>" class="am-btn am-btn-default am-btn-success"><span class="am-icon-plus"></span> 新增</a>
                        ...
                        <form class="am-form">
                            <table class="am-table am-table-striped am-table-hover table-main">
                                ...
                                <tr>
                                    ...
                                    <th class="table-title">大概内容</th>
                                    <th class="table-author am-hide-sm-only">班级ID</th>
                                ...
                                <tr>
                                    ...
                                    <td class="am-hide-sm-only"><?php echo $vo['cid']; ?></td>
                                    <td class="am-hide-sm-only"><?php echo date("Y-m-d",$vo['pubdate']); ?></td>
                                    <td>
                                        <div class="am-btn-toolbar">
                                            <div class="am-btn-group am-btn-group-xs">
                                                <a href="<?php echo url('Index/up_notice',['id'=>$vo['id']]); ?>" class="am-btn am-btn-default am-btn-xs am-text-secondary"><span class="am-icon-pencil-square-o"></span> 编辑</a>
                                                <a href="<?php echo url('Index/del_notice',['id'=>$vo['id']]); ?>" class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only"><span class="am-icon-trash-o"></span> 删除</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
