<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:76:"/data/home/bxu2713310775/htdocs/application/admin/view/index/up_newcate.html";i:1501414057;}*/ ?>
<!doctype html>
<html>
    ...
    <div class="tpl-block ">
        ...
        <div class="am-g tpl-amazeui-form">
            ...
            <div class="am-u-sm-12 am-u-md-9">
                <form class="am-form am-form-horizontal" method="post" action="<?php echo url('index/do_up_newcate'); ?>">
                    <div class="am-form-group">
                        <label for="rule_en_name" class="am-u-sm-3 am-form-label">分类标题 / Title</label>
                        <div class="am-u-sm-9">
                            <input type="hidden" name="id" value="<?php echo $userinfo['id']; ?>"/>
                            <input type="text" name="cate_title" id="rule_en_name" value="<?php echo $userinfo['cate_title']; ?>" placeholder="分类标题 / Title">
