<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:76:"/data/home/bxu2713310775/htdocs/application/admin/view/index/add_notice.html";i:1501653326;}*/ ?>
    ...
    <div class="tpl-block ">
        ...
        <div class="am-g tpl-amazeui-form">
            ...
            <div class="am-u-sm-12 am-u-md-9">
                <form action="<?php echo url('Index/do_add_notice'); ?>" method="post"  class="am-form am-form-horizontal">
