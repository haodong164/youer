<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"/data/home/bxu2713310775/htdocs/application/admin/view/index/uptheme.html";i:1499931758;}*/ ?>
<!doctype html>
<html>
    ...
    <div class="tpl-block ">
        ...
        <div class="am-g tpl-amazeui-form">
            ...
            <div class="am-u-sm-12 am-u-md-9">
                <form class="am-form am-form-horizontal" action="<?php echo url('Index/do_uptheme'); ?>" method="post">
                    <div class="am-form-group">
                        <label class="am-u-sm-3 am-form-label">话题标题 / Title</label>
                        <div class="am-u-sm-9">
                            <input type="hidden" name="id" value="<?php echo $list['id']; ?>">
                            <input type="text" name="title" value="<?php echo $list['title']; ?>" placeholder="话题标题 / Title">
                        </div>
                    </div>
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                            <textarea class="" name="content" rows="10" id="user-intro" placeholder="请输入文章内容"><?php echo $list['content']; ?></textarea>
                        </div>
                    </div>
