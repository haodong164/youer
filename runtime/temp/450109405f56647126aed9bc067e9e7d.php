            ...
            <div class="tpl-block ">
                ...
                <div class="am-g tpl-amazeui-form">
                    ...
                    <div class="am-u-sm-12 am-u-md-9">
                        <form class="am-form am-form-horizontal" method="post" action="<?php echo url('Index/do_addablumn'); ?>" enctype="multipart/form-data">
                            <div class="am-form-group">
                                <label for="user-name" class="am-u-sm-3 am-form-label">相册名 / Name</label>
                                <div class="am-u-sm-9">
                                    <input type="text" name="abname" id="user-name" placeholder="相册名 / Name">
